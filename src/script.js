...
function telljoke(event) {
  ...
  let context =
    "you are a cultured and very experienced AI generator and respond to the user with correct answers. be sure of responde without introduction or any ending, i just want the answer.";
